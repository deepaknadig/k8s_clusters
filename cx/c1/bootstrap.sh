...
cat >>/etc/hosts<<EOF
172.42.42.100 master1.example.com master1
172.42.42.101 worker11.example.com worker11
172.42.42.102 worker12.example.com worker12
EOF


echo "[TASK 2] Install docker container engine"
apt-get install apt-transport-https ca-certificates curl software-properties-common bash-completion -y
